const data = [
  {
    "id": "easy-in-a-url-shortener-what-should-be-optimized-first-for-user-experience-1-advanced-1",
    "difficulty": "easy",
    "prompt": "In a URL shortener, what should be optimized first for user experience? (core architecture reasoning)",
    "options": [
      ...
      "Long-running analytics queries over historical click streams"
    ],
    "correctIndex": 0,
  ...
  {
    "id": "easy-what-is-the-best-reason-to-place-a-queue-between-upload-and-video-transcoding-2-advanced-2",
    "difficulty": "easy",
    "prompt": "What is the best reason to place a queue between upload and video transcoding? (core architecture reasoning)",
    "options": [
  ...
  {
    "id": "easy-why-is-pagination-essential-in-high-cardinality-list-apis-3-advanced-3",
    "difficulty": "easy",
    "prompt": "Why is pagination essential in high-cardinality list APIs? (core architecture reasoning)",
    "options": [
  ...
  {
    "id": "easy-what-does-an-api-gateway-most-commonly-centralize-4-advanced-4",
    "difficulty": "easy",
    "prompt": "What does an API gateway most commonly centralize? (core architecture reasoning)",
    "options": [
  ...
  {
    "id": "easy-for-a-global-static-website-which-architecture-gives-the-fastest-first-byte-times-5-advanced-5",
    "difficulty": "easy",
    "prompt": "For a global static website, which architecture gives the fastest first-byte times? (core architecture reasoning)",
    "options": [
  ...
  {
    "id": "easy-what-is-the-key-benefit-of-health-checks-behind-a-load-balancer-6-advanced-6",
    "difficulty": "easy",
    "prompt": "What is the key benefit of health checks behind a load balancer? (core architecture reasoning)",
    "options": [
