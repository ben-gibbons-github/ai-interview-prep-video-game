const data = [
  {
    "id": "easy-in-a-url-shortener-what-should-be-optimized-first-for-user-experience-1",
    "difficulty": "easy",
  ...
  {
    "id": "easy-what-is-the-best-reason-to-place-a-queue-between-upload-and-video-transcoding-2",
    "difficulty": "easy",
  ...
  {
    "id": "easy-why-is-pagination-essential-in-high-cardinality-list-apis-3",
    "difficulty": "easy",
  ...
  {
    "id": "easy-what-does-an-api-gateway-most-commonly-centralize-4",
    "difficulty": "easy",
  ...
  {
    "id": "easy-for-a-global-static-website-which-architecture-gives-the-fastest-first-byte-times-5",
    "difficulty": "easy",
  ...
  {
    "id": "easy-what-is-the-key-benefit-of-health-checks-behind-a-load-balancer-6",
    "difficulty": "easy",
