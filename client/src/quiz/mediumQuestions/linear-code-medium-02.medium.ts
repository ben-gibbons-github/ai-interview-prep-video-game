const data = [
  ...
  {
    "id": "medium-linear-scan-02-q4",
    "difficulty": "medium",
    "prompt": "Look at this code:\n\n```ts\nfunction process(queue: number[]) {\n  const results: number[] = []\n  for (const item of queue) {\n    results.push(item * 2)\n  }\n  return results\n}\n```\n\nthen pick the right complexity from the list of answers.",
    "options": [
      "O(1)",
      "O(log N)",
      "O(N)",
