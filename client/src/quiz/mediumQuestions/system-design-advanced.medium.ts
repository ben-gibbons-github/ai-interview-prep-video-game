const data = [
  {
    "id": "medium-in-a-url-shortener-what-should-be-optimized-first-for-user-experience-1-advanced-1",
    "difficulty": "medium",
    "prompt": "In a URL shortener, what should be optimized first for user experience? (tradeoff analysis)",
    "options": [
  ...
  {
    "id": "medium-what-is-the-best-reason-to-place-a-queue-between-upload-and-video-transcoding-2-advanced-2",
    "difficulty": "medium",
    "prompt": "What is the best reason to place a queue between upload and video transcoding? (tradeoff analysis)",
    "options": [
  ...
  {
    "id": "medium-why-is-pagination-essential-in-high-cardinality-list-apis-3-advanced-3",
    "difficulty": "medium",
    "prompt": "Why is pagination essential in high-cardinality list APIs? (tradeoff analysis)",
    "options": [
  ...
  {
    "id": "medium-what-does-an-api-gateway-most-commonly-centralize-4-advanced-4",
    "difficulty": "medium",
    "prompt": "What does an API gateway most commonly centralize? (tradeoff analysis)",
    "options": [
  ...
  {
    "id": "medium-for-a-global-static-website-which-architecture-gives-the-fastest-first-byte-times-5-advanced-5",
    "difficulty": "medium",
    "prompt": "For a global static website, which architecture gives the fastest first-byte times? (tradeoff analysis)",
    "options": [
  ...
  {
    "id": "medium-what-is-the-key-benefit-of-health-checks-behind-a-load-balancer-6-advanced-6",
    "difficulty": "medium",
    "prompt": "What is the key benefit of health checks behind a load balancer? (tradeoff analysis)",
    "options": [
