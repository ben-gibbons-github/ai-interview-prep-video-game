const data = [
  {
    "id": "hard-in-clean-code-what-is-the-core-goal-of-meaningful-names-1",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "To enforce one-letter variables in all loops and methods",
  ...
  {
    "id": "hard-what-does-the-single-responsibility-principle-emphasize-2",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "A project should enforce one repository per class",
  ...
  {
    "id": "hard-according-to-open-closed-principle-software-entities-should-be-3",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "Closed to dependency inversion to reduce indirection",
  ...
  {
    "id": "hard-what-does-dependency-inversion-principle-recommend-4",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "Depend on direct imports from low-level modules"
    ],
    "correctIndex": 0,
  ...
  {
    "id": "hard-a-clean-function-should-usually-be-5",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "Dependent on mutable global state by default"
    ],
    "correctIndex": 0,
  ...
  {
    "id": "hard-why-are-code-reviews-aligned-with-clean-code-principles-6",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "They eliminate all technical debt automatically",
