const data = [
  {
    "id": "hard-why-use-repository-pattern-in-backend-services-1",
    "difficulty": "hard",
  ...
  {
    "id": "hard-what-is-a-practical-benefit-of-cqrs-in-suitable-domains-2",
    "difficulty": "hard",
  ...
  {
    "id": "hard-why-is-idempotency-important-for-command-handlers-3",
    "difficulty": "hard",
    "prompt": "Why is idempotency important for command handlers?",
    "options": [
      "Retries should not produce duplicate side effects",
      "It avoids storing request correlation identifiers",
  ...
  {
    "id": "hard-what-does-the-unit-of-work-pattern-coordinate-4",
    "difficulty": "hard",
  ...
  {
    "id": "hard-a-clean-service-layer-should-primarily-5",
    "difficulty": "hard",
  ...
  {
    "id": "hard-why-use-feature-flags-in-iterative-delivery-6",
    "difficulty": "hard",
    ...
    "options": [
      ...
      "To replace incident rollback procedures entirely"
    ],
    "correctIndex": 0,
