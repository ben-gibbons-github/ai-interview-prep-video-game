const data = [
  {
    "id": "hard-in-a-url-shortener-what-should-be-optimized-first-for-user-experience-1-advanced-1",
    "difficulty": "hard",
    "prompt": "In a URL shortener, what should be optimized first for user experience? (multi-region failure semantics)",
    "options": [
  ...
  {
    "id": "hard-what-is-the-best-reason-to-place-a-queue-between-upload-and-video-transcoding-2-advanced-2",
    "difficulty": "hard",
    "prompt": "What is the best reason to place a queue between upload and video transcoding? (multi-region failure semantics)",
    "options": [
  ...
  {
    "id": "hard-why-is-pagination-essential-in-high-cardinality-list-apis-3-advanced-3",
    "difficulty": "hard",
    "prompt": "Why is pagination essential in high-cardinality list APIs? (multi-region failure semantics)",
    "options": [
  ...
  {
    "id": "hard-what-does-an-api-gateway-most-commonly-centralize-4-advanced-4",
    "difficulty": "hard",
    "prompt": "What does an API gateway most commonly centralize? (multi-region failure semantics)",
    "options": [
  ...
  {
    "id": "hard-for-a-global-static-website-which-architecture-gives-the-fastest-first-byte-times-5-advanced-5",
    "difficulty": "hard",
    "prompt": "For a global static website, which architecture gives the fastest first-byte times? (multi-region failure semantics)",
    "options": [
  ...
  {
    "id": "hard-what-is-the-key-benefit-of-health-checks-behind-a-load-balancer-6-advanced-6",
    "difficulty": "hard",
    "prompt": "What is the key benefit of health checks behind a load balancer? (multi-region failure semantics)",
    "options": [
